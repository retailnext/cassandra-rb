...
module CassandraThrift
  module ConsistencyLevel
    ...
    LOCAL_SERIAL = 10
    LOCAL_ONE = 11
    VALUE_MAP = {1 => "ONE", 2 => "QUORUM", 3 => "LOCAL_QUORUM", 4 => "EACH_QUORUM", 5 => "ALL", 6 => "ANY", 7 => "TWO", 8 => "THREE", 9 => "SERIAL", 10 => "LOCAL_SERIAL", 11 => "LOCAL_ONE"}
    VALID_VALUES = Set.new([ONE, QUORUM, LOCAL_QUORUM, EACH_QUORUM, ALL, ANY, TWO, THREE, SERIAL, LOCAL_SERIAL, LOCAL_ONE]).freeze
  end
...
# protocol, as opposed to during the commit of our update
      PAXOS_IN_PROGRESS => {:type => ::Thrift::Types::BOOL, :name => 'paxos_in_progress', :optional => true}
    }
...
# @param deletion. A deletion of a column or supercolumn
  ...
  class CASResult
    ...
    FIELDS = {
      ...
      CURRENT_VALUES => {:type => ::Thrift::Types::LIST, :name => 'current_values', :element => {:type => ::Thrift::Types::STRUCT, :class => ::CassandraThrift::Column}, :optional => true}
    }
...
# Other options are not supported yet.
  ...
  class CfDef
    ...
    MEMTABLE_FLUSH_PERIOD_IN_MS = 39
    DEFAULT_TIME_TO_LIVE = 40
    SPECULATIVE_RETRY = 42
    TRIGGERS = 43
    CELLS_PER_ROW_TO_CACHE = 44
    MIN_INDEX_INTERVAL = 45
    MAX_INDEX_INTERVAL = 46
    ROW_CACHE_SIZE = 9
    KEY_CACHE_SIZE = 11
    ...
    FIELDS = {
      ...
      MEMTABLE_FLUSH_PERIOD_IN_MS => {:type => ::Thrift::Types::I32, :name => 'memtable_flush_period_in_ms', :optional => true},
      DEFAULT_TIME_TO_LIVE => {:type => ::Thrift::Types::I32, :name => 'default_time_to_live', :optional => true},
      SPECULATIVE_RETRY => {:type => ::Thrift::Types::STRING, :name => 'speculative_retry', :default => %q"NONE", :optional => true},
      TRIGGERS => {:type => ::Thrift::Types::LIST, :name => 'triggers', :element => {:type => ::Thrift::Types::STRUCT, :class => ::CassandraThrift::TriggerDef}, :optional => true},
      CELLS_PER_ROW_TO_CACHE => {:type => ::Thrift::Types::STRING, :name => 'cells_per_row_to_cache', :default => %q"100", :optional => true},
      MIN_INDEX_INTERVAL => {:type => ::Thrift::Types::I32, :name => 'min_index_interval', :optional => true},
      MAX_INDEX_INTERVAL => {:type => ::Thrift::Types::I32, :name => 'max_index_interval', :optional => true},
      # @deprecated
      ...
      # @deprecated
      INDEX_INTERVAL => {:type => ::Thrift::Types::I32, :name => 'index_interval', :optional => true}
    }
...
# @param finish. The end of the ColumnSlice inclusive
  class ColumnSlice
    ...
    FIELDS = {
      START => {:type => ::Thrift::Types::STRING, :name => 'start', :binary => true, :optional => true},
      FINISH => {:type => ::Thrift::Types::STRING, :name => 'finish', :binary => true, :optional => true}
    }
...
# @param consistency_level. Level to perform the operation at
  class MultiSliceRequest
    ...
    FIELDS = {
      KEY => {:type => ::Thrift::Types::STRING, :name => 'key', :binary => true, :optional => true},
      COLUMN_PARENT => {:type => ::Thrift::Types::STRUCT, :name => 'column_parent', :class => ::CassandraThrift::ColumnParent, :optional => true},
      COLUMN_SLICES => {:type => ::Thrift::Types::LIST, :name => 'column_slices', :element => {:type => ::Thrift::Types::STRUCT, :class => ::CassandraThrift::ColumnSlice}, :optional => true},
      REVERSED => {:type => ::Thrift::Types::BOOL, :name => 'reversed', :default => false, :optional => true},
      COUNT => {:type => ::Thrift::Types::I32, :name => 'count', :default => 1000, :optional => true},
      CONSISTENCY_LEVEL => {:type => ::Thrift::Types::I32, :name => 'consistency_level', :default =>       1, :optional => true, :enum_class => ::CassandraThrift::ConsistencyLevel}
    }
