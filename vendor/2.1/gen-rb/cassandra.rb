...
module CassandraThrift
  module Cassandra
    class Client
      ...
      def send_cas(key, column_family, expected, updates, serial_consistency_level, commit_consistency_level)
        send_message('cas', Cas_args, :key => key, :column_family => column_family, :expected => expected, :updates => updates, :serial_consistency_level => serial_consistency_level, :commit_consistency_level => commit_consistency_level)
      end

      def recv_cas()
        result = receive_message(Cas_result)
        return result.success unless result.success.nil?
        raise result.ire unless result.ire.nil?
        raise result.ue unless result.ue.nil?
        raise result.te unless result.te.nil?
        raise ::Thrift::ApplicationException.new(::Thrift::ApplicationException::MISSING_RESULT, 'cas failed: unknown result')
      end
      ...
      def get_multi_slice(request)
        send_get_multi_slice(request)
        return recv_get_multi_slice()
      end

      def send_get_multi_slice(request)
        send_message('get_multi_slice', Get_multi_slice_args, :request => request)
      end

      def recv_get_multi_slice()
        result = receive_message(Get_multi_slice_result)
        return result.success unless result.success.nil?
        raise result.ire unless result.ire.nil?
        raise result.ue unless result.ue.nil?
        raise result.te unless result.te.nil?
        raise ::Thrift::ApplicationException.new(::Thrift::ApplicationException::MISSING_RESULT, 'get_multi_slice failed: unknown result')
      end
      ...
      def send_describe_local_ring(keyspace)
        send_message('describe_local_ring', Describe_local_ring_args, :keyspace => keyspace)
      end

      def recv_describe_local_ring()
        result = receive_message(Describe_local_ring_result)
        return result.success unless result.success.nil?
        raise result.ire unless result.ire.nil?
        raise ::Thrift::ApplicationException.new(::Thrift::ApplicationException::MISSING_RESULT, 'describe_local_ring failed: unknown result')
      end
    ...
    class Processor
      ...
      def process_cas(seqid, iprot, oprot)
        args = read_args(iprot, Cas_args)
        result = Cas_result.new()
        begin
          result.success = @handler.cas(args.key, args.column_family, args.expected, args.updates, args.serial_consistency_level, args.commit_consistency_level)
        rescue ::CassandraThrift::InvalidRequestException => ire
          result.ire = ire
        rescue ::CassandraThrift::UnavailableException => ue
          result.ue = ue
        ...
        write_result(result, oprot, 'cas', seqid)
      end
      ...
      def process_get_multi_slice(seqid, iprot, oprot)
        args = read_args(iprot, Get_multi_slice_args)
        result = Get_multi_slice_result.new()
        begin
          result.success = @handler.get_multi_slice(args.request)
        rescue ::CassandraThrift::InvalidRequestException => ire
          result.ire = ire
        rescue ::CassandraThrift::UnavailableException => ue
          result.ue = ue
        ...
        write_result(result, oprot, 'get_multi_slice', seqid)
      end
      ...
      def process_describe_local_ring(seqid, iprot, oprot)
        args = read_args(iprot, Describe_local_ring_args)
        result = Describe_local_ring_result.new()
        begin
          result.success = @handler.describe_local_ring(args.keyspace)
        rescue ::CassandraThrift::InvalidRequestException => ire
          result.ire = ire
        end
        write_result(result, oprot, 'describe_local_ring', seqid)
      end
    ...
    class Cas_args
      ...
      EXPECTED = 3
      UPDATES = 4
      SERIAL_CONSISTENCY_LEVEL = 5
      COMMIT_CONSISTENCY_LEVEL = 6

      FIELDS = {
        KEY => {:type => ::Thrift::Types::STRING, :name => 'key', :binary => true},
        COLUMN_FAMILY => {:type => ::Thrift::Types::STRING, :name => 'column_family'},
        EXPECTED => {:type => ::Thrift::Types::LIST, :name => 'expected', :element => {:type => ::Thrift::Types::STRUCT, :class => ::CassandraThrift::Column}},
        UPDATES => {:type => ::Thrift::Types::LIST, :name => 'updates', :element => {:type => ::Thrift::Types::STRUCT, :class => ::CassandraThrift::Column}},
        SERIAL_CONSISTENCY_LEVEL => {:type => ::Thrift::Types::I32, :name => 'serial_consistency_level', :default =>         9, :enum_class => ::CassandraThrift::ConsistencyLevel},
        COMMIT_CONSISTENCY_LEVEL => {:type => ::Thrift::Types::I32, :name => 'commit_consistency_level', :default =>         2, :enum_class => ::CassandraThrift::ConsistencyLevel}
      }
      ...
      def validate
        raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field key is unset!') unless @key
        raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field column_family is unset!') unless @column_family
        raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field serial_consistency_level is unset!') unless @serial_consistency_level
        raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field commit_consistency_level is unset!') unless @commit_consistency_level
        unless @serial_consistency_level.nil? || ::CassandraThrift::ConsistencyLevel::VALID_VALUES.include?(@serial_consistency_level)
          raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Invalid value of field serial_consistency_level!')
        end
        unless @commit_consistency_level.nil? || ::CassandraThrift::ConsistencyLevel::VALID_VALUES.include?(@commit_consistency_level)
          raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Invalid value of field commit_consistency_level!')
        end
      end
    ...
    class Cas_result
      ...
      FIELDS = {
        SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::CassandraThrift::CASResult},
        IRE => {:type => ::Thrift::Types::STRUCT, :name => 'ire', :class => ::CassandraThrift::InvalidRequestException},
        UE => {:type => ::Thrift::Types::STRUCT, :name => 'ue', :class => ::CassandraThrift::UnavailableException},
        TE => {:type => ::Thrift::Types::STRUCT, :name => 'te', :class => ::CassandraThrift::TimedOutException}
      }
    ...
    class Get_multi_slice_args
      ...
      FIELDS = {
        REQUEST => {:type => ::Thrift::Types::STRUCT, :name => 'request', :class => ::CassandraThrift::MultiSliceRequest}
      }
