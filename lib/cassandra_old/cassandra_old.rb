=begin rdoc
Create a new CassandraOld client instance. Accepts a keyspace name, and optional host and port.
...
class CassandraOld
  ...
  ##
  # Creates a new client as specified by CassandraOld.thrift_client_options[:thrift_client_class]
  #
  def new_client
